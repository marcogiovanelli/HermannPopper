...
%DIF ADD hermannpopper.tex   Sat Jul 25 10:29:59 2026
...
%DIFDELCMD <  
%DIFDELCMD < %%%
\DIFdelend \section{The Popper-\vW Correspondence on Popper's Thought Experiment}
...
\end{equation*}
%
Popper's idea was that the impact point would provide a momentum measurement followed by a position measurement. \VW's objection was that the experiment's geometry already contains the limits expressed by the uncertainty principle.\DIFdelbegin %DIFDELCMD < \footnoteh{See appendix \cref{app:1} for more details}%%%
...
%DIFDELCMD < %%%
\DIFdelend \section{The Hermann-\vW Correspondence on Popper's Thought Experiment}
%
